...
def run_sabre(data, edges, layout="sabre", trial="single"):
    ...
    if trial.lower() == "single":
        sabre_swap_pass = SabreSwap(coupling_map=coupling_map, heuristic="decay", seed=21, trials=1)
    else:  # multi trial
        sabre_swap_pass = SabreSwap(coupling_map=coupling_map, heuristic="decay", seed=21)
